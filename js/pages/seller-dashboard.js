// ==================== CONFIGURATION ====================
        ...
        function renderTiers() {
            ...
            for (const [k, d] of Object.entries(tierMap)) {
                ...
                c.innerHTML += `<div class="tier-card ${a ? 'tier-highlight' : ''}">
                    ...
                    <button class="btn-primary subscribe-btn" data-tier="${k}" style="margin-top:18px;width:100%;" ${a ? 'disabled' : ''} ${dg ? 'disabled' : ''}>
        ...
        function updateStatsAndLimits() {
            ...
            document.getElementById('tierMessage').innerHTML = currentTier === 'free' 
